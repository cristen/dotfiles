...
" language fr_FR.UTF-8           " Solve some plugins incompatibilities
...
NeoBundleLazy 'mattn/emmet-vim', {'autoload':
            \ {'filetypes': ['html', 'xhttml', 'css', 'xml', 'xls', 'markdown', 'jinja', 'jinja2']}}
" }}}
...
map <localleader>T :wincmd h<CR>
map <localleader>S :wincmd j<CR>
map <localleader>R :wincmd k<CR>
map <localleader>N :wincmd l<CR>

"Switch between tabs
map <localleader>t :tabp<CR>
map <localleader>n :tabn<CR>

" push word under cursor to the left
nnoremap <silent> jv "_yiw?\w\+\_W\+\%#<CR>:s/\(\%#\w\+\)\(\_W\+\)\(\w\+\)/\3\2\1/<CR><C-o><C-l>

" push word under cursor to the right
nnoremap <silent> vj "_yiw:s/\(\%#\w\+\)\(\_W\+\)\(\w\+\)/\3\2\1/<CR><C-o>/\w\+\_W\+<CR><C-l>
...
au BufRead,BufWrite,BufWinEnter *.jinja2,*.jinja set filetype=jinja
au BufRead,BufWrite,BufWinEnter *.jinja set sw=2
